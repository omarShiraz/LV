$(function(){
    $('#Gender').children("div").css("background","gold").selectmenu();
});

$(function(){
    $("#style").children("div").css("background","gold").selectmenu();
});
...
$(function(){
    ...
    }).css("background","rgba(187, 37, 130, 0.733)").children("div").css("background","gold");
})
...
$(function(){
    ...
    }).css("background","purple").children("div").css("background","gold")
...
$(function(){
    $("#colour").children("div").css("background","gold").selectmenu();
});
                        ...
                        {
                            {
                                ...
                                content += "<li data-id='"+ c +"'>"                                   
                                    +"<div class = print>" 
                                        ...
                                        +"<div class = 'printImg'>"
                                            +"<img src =" + data.shoes[i].picture + " style = height:50%;width:80%;>"
                                        +"</div>" 
